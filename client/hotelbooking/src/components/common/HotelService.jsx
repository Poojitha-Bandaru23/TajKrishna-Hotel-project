  ...
  return (
    <>
      <Container className="mb-2">
        <Header title={"Our Services"} className="service-header" />
        <Row>
          <h4 className="text-center mt-3">
            Services at <span className="hotel-color">Taj Krishna </span>
            Hotel
          ...
          <Col>
            <Card>
              <Card.Body>
                ...
                <Card.Text>
                  Keep cool all year around with our swimming pool.
                </Card.Text>
              </Card.Body>
            </Card>
          </Col>
